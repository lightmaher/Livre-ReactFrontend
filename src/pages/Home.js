    ...
    <>
      <div>
        <div className="search-bar">
          <div className="st">
            <h2>Your online book Library to you with Zero Cost</h2>
          ...
          <InputGroup controlId="floatingInput" label="Search" className="mb-3">
            ...
            <Link
              ...
              style={{ color: "#ffff", padding: "2%", width: "10em" }}
              id="button-addon2  "
              type="button"
              to={"/search/" + searchValue}
            >
              <span style={{ padding: "5%", marginLeft: "4%" }}>
        ...
        <div className="container sec2-cont">
          <div className="sec2-p">
            ...
            <Link
              ...
              to="/books"
              style={{ backgroundColor: "#FFE000", width: "17vw" }}
            >
