...
const params = useParams();
  ...
  <InputGroup 
    ...
    <Link className='btn btn-info ' variant="outline-secondary" style={{color:'#ffff' ,  padding:'2%',width:'10em'}} 
    id="button-addon2  "  type="button" to={"/search/"+searchValue} >
    <span style={{padding:'5%' , marginLeft:'4%'}}><FontAwesomeIcon icon={faMagnifyingGlass} /></span>Search</Link>
  </InputGroup>
