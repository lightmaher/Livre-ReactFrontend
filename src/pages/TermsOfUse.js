    ...
    <div className="terms p-5 mb-5 ">
      ...
      <img src="terms-of-service.png" className="img-fluid" alt="terms-of-service.png" />
        ...
        <div className="accordion ps-5 pe-5 " id="accordionExample">
          ...
          <p>
            The Livre website located at Livre.net is a copyrighted work
            belonging to Bytes N. Certain features of the Site may be subject to
...
Copyright Policy              </button>
          ...
          <p>
            ...
            Notice to the Company should be sent to: Egypt. After the Notice is
      ...
      {/* <div className="container terms">
        <div>
          <h2> Livre Website Terms of Use</h2>
