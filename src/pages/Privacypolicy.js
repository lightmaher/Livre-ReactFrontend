        ...
        <div className="accordion" id="accordionExample">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  At Livre, accessible from Livre.net, one of our main
                  priorities is the privacy of our visitors. This Privacy Policy
                  document contains types of information that is collected and
                  recorded by Livre and how we use it.
                </p>
                <p>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  Bytes N legal basis for collecting and using the personal
                ...
                <ul>
                  <li>Bytes N needs to perform a contract with you</li>
                  <li>You have given Bytes N permission to do so</li>
                  <li>
                    Processing your personal information is in Bytes N
                    legitimate interests
                  </li>
                  <li>Bytes N needs to comply with the law</li>
                </ul>
                <p>
                  Bytes N will retain your personal information only for as long
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  Livre follows a standard procedure of using log files. These
            ...
            >
              <div className="accordion-body">
                <p>
                  ...
                  of the advertising partners of Livre.
                </p>
                <p>
                  Third-party ad servers or ad networks uses technologies like
                  cookies, JavaScript, or Web Beacons that are used in their
                  respective advertisements and links that appear on Livre,
                ...
                <p>
                  Note that Livre has no access to or control over these cookies
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  Livre's Privacy Policy does not apply to other advertisers or
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                <p>
                  Livre does not knowingly collect any Personal Identifiable
            ...
            >
              <div className="accordion-body">
                <p>
                  ...
                  information that they shared and/or collect in Livre. This
