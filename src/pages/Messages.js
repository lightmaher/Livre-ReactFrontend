...
const sendmessage = (e) => {
    ...
    {
        axiosInstance.post('message/' + userid , {'content' : e.target.content.value}).then(
            ...
            <div id="plist" class="people-list">
                ...
                {sentusers.map(user => { return(
                    ...
                    <div class="about">
                        ...
                        <img src={"http://127.0.0.1:8000" + user.img} style={{width:"100px",height:"100px"}}  alt="" />
                    ...
                    {Messages.filter(name => name.m_sender.username === user || name.m_receiver.username === user).slice(-5).map(message => (
                        ...
                        <li class="clearfix">
                            <div class="message-data text-end">
                                <span class="message-data-time">{message.date_creation}</span>
                            </div>
